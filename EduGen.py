...
#submisson
    ...
    time.sleep(3)
    generated += 1
    print(generated , "/" , accounts , " Accounts are done! Please Join the discord server: https://discord.gg/SWuCuez")
    with open("accountsb.txt", "a+") as file:
        file.write(name + ":" + pw + "  Email:" + email + " " + first + " " + last + " SSN: " + ssn + " number: " + number)
        file.write("\n")
...
Modded by default-github-user

⚡Yohann⚡#9584 for seth univers 
https://discord.gg/SWuCuez
